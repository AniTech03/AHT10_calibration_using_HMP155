...
# Rounding timestamps to nearest minute for alignment
...
# ================= SAVE MERGED FILE =================
merged.to_csv("AHT10_HMP_Merged_with_Error_24th_oct.csv", index=False)
print("✅ Merged data with errors saved as 'AHT10_HMP_Merged_with_Error_24th_oct.csv'")
